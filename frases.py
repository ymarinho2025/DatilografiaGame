# -*- coding: utf-8 -*-
"""
Fases e textos do jogo.

Observação:
- Este arquivo não inclui letras completas de músicas protegidas por direitos autorais.
- Os títulos pedidos aparecem como temas de fase.
- As fases de músicas usam textos autorais temáticos.
- O Salmo 91 aparece como paráfrase autoral.
"""
...
BONUS_PHASE = {
    ...
    "text": (
        "Não tem por onde escapar. A máquina puxa outra folha, a mesa treme de leve e o farol exige "
        "mais uma mensagem. Agora os pontos valem em dobro, mas a roleta continua esperando qualquer "
        "letra fora de ordem. Respire, olhe para o próximo caractere e continue."
    ),
}
